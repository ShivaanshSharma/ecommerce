    ...
    return (
        <div>
            <ul className="flex items-center bg-red-900 text-white text-xs shadow-md gap-3">
                ...
                <li className="duration-150 p-3 hover:text-red-900 hover:bg-white"><NavLink className={({isActive}) => isActive ? 'underline' : null} to="/contact">Contact Us</NavLink></li>
                <li className="duration-150 p-3 hover:text-red-900 hover:bg-white"><NavLink className={({isActive}) => isActive ? 'underline' : null} to="/about">About Us</NavLink></li>
            </ul>
        </div>
    )
}