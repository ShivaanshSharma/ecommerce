    ...
    return (
        <div>
            <ul className="flex items-center bg-red-900 text-white text-xs shadow-md gap-3">
                <li className="hover:text-red-900 hover:bg-white duration-150 p-3 ml-3"><NavLink className={({isActive}) => isActive ? 'underline' : null} to="/ecommerce" end>Home</NavLink></li>
                <li className="duration-150 p-3 hover:text-red-900 hover:bg-white"><NavLink className={({isActive}) => isActive ? 'underline' : null} to="/ecommerce/products">Products</NavLink></li>
