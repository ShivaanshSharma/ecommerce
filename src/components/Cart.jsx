...
export default function Cart () {
    ...
    if(cart.length === 0) {
        content = <>
            ...
            <Link className="mx-auto duration-150 bg-red-900 w-fit text-white p-3 rounded-xl hover:border-1 hover:border-red-900 hover:bg-white hover:text-red-900" to="/ecommerce/products">Start Shopping Now!</Link>
        </>
    } else {
        content = <>
