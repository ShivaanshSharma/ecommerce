...
export default function HomePage() {
    return (
        <div className="image flex flex-row text-left">
            <div className="my-40 mx-30 flex flex-col gap-4">
                ...
                <Link className="duration-150 bg-red-900 w-fit text-white p-3 rounded-xl hover:bg-white hover:text-red-900" to="/products">Start Shopping Now</Link>
            </div>
            <div>
