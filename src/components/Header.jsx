...
export default function Header () {
    ...
    return (
        <div className="bg-gray-200 p-3 text-red-600 flex flex-row items-center place-content-between">
            ...
            <span className='cursor-pointer bg-red-900 mx-4 text-white p-1 rounded hover:bg-white hover:text-red-600 text-2xl duration-300'><Link to='/ecommerce/Cart'><CiShoppingCart /></Link></span>
        </div>
    )
}